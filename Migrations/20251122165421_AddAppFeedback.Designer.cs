...
namespace CoHabit.API.Migrations
{
    ...
    [Migration("20251122165421_AddAppFeedback")]
    partial class AddAppFeedback
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoHabit.API.Enitites.AppFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MostFavoriteFeature")
                        .HasMaxLength(500)
            ...
            modelBuilder.Entity("CoHabit.API.Enitites.UserSubcription", b =>
                {
                    b.Property<int>("UserSubcriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UserSubcriptionId"));
            ...
            modelBuilder.Entity("CoHabit.API.Enitites.AppFeedback", b =>
                {
                    b.HasOne("CoHabit.API.Enitites.User", "User")
                        .WithOne("AppFeedback")
                        .HasForeignKey("CoHabit.API.Enitites.AppFeedback", "UserId")
            ...
            modelBuilder.Entity("CoHabit.API.Enitites.Conversation", b =>
                {
                    b.HasOne("CoHabit.API.Enitites.User", "InterestedUser")
                        .WithMany("InterestedConversations")
                        .HasForeignKey("InterestedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CoHabit.API.Enitites.User", "Owner")
            ...
            modelBuilder.Entity("CoHabit.API.Enitites.Message", b =>
                {
                    b.HasOne("CoHabit.API.Enitites.Conversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("CoHabit.API.Enitites.Order", b =>
                {
                    b.HasOne("CoHabit.API.Enitites.Conversation", "Conversation")
                        .WithOne("Order")
                        .HasForeignKey("CoHabit.API.Enitites.Order", "ConversationId")
            ...
            modelBuilder.Entity("CoHabit.API.Enitites.User", b =>
                {
                    b.Navigation("AppFeedback");

                    b.Navigation("InterestedConversations");
